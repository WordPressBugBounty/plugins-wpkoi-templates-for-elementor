...
define( 'WPKOI_ELEMENTS_LITE_VERSION', '1.7.1' );
...
if ( $wtfe_interactive_cursor  != true ) {
	require_once plugin_dir_path( __FILE__ ) . 'elements/interactive-cursor/interactive-cursor.php';
}
