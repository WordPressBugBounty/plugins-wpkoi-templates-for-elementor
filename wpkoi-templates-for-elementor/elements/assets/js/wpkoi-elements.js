        ...
        r = {
            init: function () {
                var i = {
					...
					"wpkoi-lottie-animations.default": r.widgetLottieAnimations,
                };
			...
			widgetLottieAnimations: function($scope) {
				var lottieAnimations = $scope.find('.wpkoi-lottie-animations'),
					lottieAnimationsWrap = $scope.find('.wpkoi-lottie-animations-wrapper'),
